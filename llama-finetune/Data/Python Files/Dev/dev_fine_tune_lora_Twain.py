...
OUTPUT_DIR    = os.path.join(BASE_DIR, "model_output_dev")
...
fh = logging.FileHandler(os.path.join(LOG_DIR, "fine_tune_twain_dev.log"))
...
logger.info("Dev smoke-test complete for Mark Twain.")
