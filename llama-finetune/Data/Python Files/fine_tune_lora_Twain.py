...
fh = logging.FileHandler(os.path.join(LOG_DIR, "fine_tune_twain.log"))
fh.setFormatter(logging.Formatter(
    "%(asctime)s %(levelname)s: %(message)s", "%Y-%m-%d %H:%M:%S"
))
logger.addHandler(fh)
logger.info("Starting full fine-tuning for Mark Twain")
...
# gradient checkpointing can be unstable in this version—enable if you need it
...
trainer = Trainer(
    ...
    eval_dataset=None,          # no auto eval during training
...
logger.info("Full fine-tuning for Mark Twain complete.")
